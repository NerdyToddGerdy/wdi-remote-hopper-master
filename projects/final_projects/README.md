...
Note: Due to the Memorial Day holiday, there will be **no** TA hours on Saturday, May 27th and no class on Monday, May 29th.

There will be optional topics taught on some mornings (schedule to be announced).

Occasional 15 minute meetings to check in with instructors. We will do things like check your overall progress and direct you to resources.
...
* Work through the lessons in class for help and inspiration! Think about adding relevant code to your application each day -  so that you can work on it in small chunks, **COMMIT OFTEN**. We will be looking at your commit dates and comments are part of your scoring.
...
4. Submit a Github issue **on the class Github repo** to receive help from an instructor. Note: You must do `@your_instructors_github_handle`, inside the comment area of your issue, to notify your instructor that you have created an issue.

## Formatting your GitHub Issue for your class repo to ask for help
